...
class Cms_Contact_Form_Loader {
	 ...
	 *
	 * @since    1.0.0
	 * @param    string $tag The name of the Shortcode that is being create.
	 ...
	 * @since    1.0.0
	 * @access   private
	 * @param    array  $shortcodes The collection of shortcode that is being created.
